...
// function to fetch popular movies
  function getPlayMovie() {
    axios
      .get('http://localhost:5678/nowplaying') // request to the backend
...
//Add movie selected to the database
  ...
  useEffect(() => {
    getPlayMovie(); // Fetch movies data when the component mounts
  }, []);
  ...
  return (
    <>
      <h4 style={{ paddingTop: "5px", margin: "10px" }}>Now Playing</h4>
      <div
...
export default PlayMovie; // Export Popular component
