...
// function to fetch popular movies
  function getPopularlog() {
    axios
      .get('http://localhost:5678/popular') // request to the backend
...
//Add movie selected to the database
  ...
  useEffect(() => {
    getPopularlog(); // Fetch movies data when the component mounts
  }, []);
  ...
  return (
    <>
      <h4 style={{ paddingTop: "5px", margin: "10px" }}>Popular</h4>
      <div
...
export default Popularlog; // Export Popular component
