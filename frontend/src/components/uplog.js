...
// function to fetch popular movies
  function getUpcomingMovies() {
    axios
      .get('http://localhost:5678/upcoming') // request to the backend
...
//Add movie selected to the database
  ...
  useEffect(() => {
    getUpcomingMovies(); // Fetch movies data when the component mounts
  }, []);
  ...
  return (
    <>
      <h4 style={{ paddingTop: "5px", margin: "10px" }}>Upcoming</h4>
      <div
...
export default UpcomingMovies; // Export Popular component
